Model generated using evaluateML.py, includes export command, and uses pre-processed file "solo_data.csv" which contains only sugar and melon testing during independent trials.
